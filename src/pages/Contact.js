  ...
  return (
    <div>
      ...
      <label htmlFor="my-modal-4" className="modal cursor-pointer">
        <label
          className="modal-box text-left relative h-96"
          htmlFor="my-modal-4"
          id="nesto"
        >
          <div className="font-serif font-black opacity-100" id="nestodrugo">
            ...
            <ul className="font-serif mb-2 font-black text-xs">
              <li>Tel 1: 075/331-037</li>
              <li>Tel 2: 070/678-783</li>
              <li>Landline: 072/121-843</li>
            </ul>
            <div className="flex justify-end">
              <h3>Our mailing adress:</h3>
            </div>
            <div className="flex justify-end text-sm flex-col">
              <a
                href="mailto: kpancevski19@gmail.com"
                className="flex justify-end"
              >
                Sweetster_official@gmail.com
              </a>
            </div>
          </div>
        </label>
      </label>
      {useFind && <FindUs useFind={useFind} setUseFind={setUseFind} />}
    </div>
  );
};
